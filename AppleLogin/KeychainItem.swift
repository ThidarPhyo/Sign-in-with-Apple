...
struct KeychainItem {
    ...
    static var currentToken: String? {
        get {
            return try? KeychainItem(service: bundleIdentifier, account: "currentToken").readItem()
        }
        set {
            guard let value = newValue else {
                try? KeychainItem(service: bundleIdentifier, account: "currentToken").deleteItem()
                return
            }
            do {
                try KeychainItem(service: bundleIdentifier, account: "currentToken").saveItem(value)
            } catch {
                print("Unable to save currentToken to keychain.")
            }
        }
    }
}
